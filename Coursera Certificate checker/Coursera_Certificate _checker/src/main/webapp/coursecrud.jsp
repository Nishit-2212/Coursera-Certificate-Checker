...
<html lang="en">
   ...
   <body>
      ...
      <div class="wrapper">
                     ...
                     <div class="form-wrapper">
                        ...
                        <div class="input-text">
                           <div class="username">
                              ...
                              <input type="username" name="course"  id="name" placeholder="Course name" />
                           </div>
         ...
         <%} %>
                        ...
                        <br>
                        <a>
                           <input type="submit" name="action" class="sign-btn" value="Add course">
                           <div class="link">
  ...
  <tbody>
  <%List<Course> list1 = AdminDao.getAllCourse(); %>
  <%for(Course u1:list1){ %>
    <tr>
    	<td><%=u1.getId() %></td>
    	<td><%=u1.getCourse() %></td>
