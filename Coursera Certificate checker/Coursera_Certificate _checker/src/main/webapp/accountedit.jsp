        ...
        <div class="col-md-8 col-10" style="padding:20px 0">
            ...
            <div class='ci-text'>
              ...
              <input type='hidden' name='id' value='<%= s.getId() %>'>
                ...
                <p style='text-align:center'><input type='text' name='name' value='<%= s.getName() %>'>
                  </p>
            </div>
            <div class='ci-text'>
           ...
           <a href='accountedit.jsp' class='btn logbtn' style='width: 200px; height:40px'> <input type="submit"  value="Update"></a></form>
