...
<html lang="en">
                     ...
                     <div class="form-wrapper">
                        ...
                        <div class="input-text">
                           <div class="username">
                              ...
                              <input type="username" name="department"  id="name" placeholder="department" />
                           </div>
                        ...
                        <br>
                        <a>
                           <input type="submit" name="action" class="sign-btn" value="Add Department">
                           <div class="link">
  ...
  <%for(Department u1:list){ %>
    <tr>
    	<td><%=u1.getId() %></td>
    	<td><%=u1.getDepartment() %></td>
    	
    	<td>
    		<form action="AdminController" method="post">
    			<input type="hidden" name="id" value="<%=u1.getId()%>">
    			<input type="hidden" name="action" value="department_edit">
