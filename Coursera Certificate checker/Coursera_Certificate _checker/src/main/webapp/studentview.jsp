...
<html lang="en">
  ...
  %>
  <%List<Student> list = AdminDao.getStudentBydsd(division_id,semester_id,department_id); %>
  <%for(Student u1:list){ %>
    <tr>
    	<td><%=u1.getId() %></td>
    	<td><%=u1.getName() %></td>
    	...
    	<td><%=u1.getEnrollment_no() %></td>
    	
    	<td>
    		<form action="AdminController" method="post">
    			<input type="hidden" name="id" value="<%=u1.getId()%>">
    			<input type="hidden" name="action" value="student_edit">
