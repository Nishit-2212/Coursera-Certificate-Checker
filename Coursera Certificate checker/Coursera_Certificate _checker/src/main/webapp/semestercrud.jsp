...
<html lang="en">
   ...
   <body>
      ...
      <div class="wrapper">
                     ...
                     <div class="form-wrapper">
                        ...
                        <div class="input-text">
                           <div class="username">
                              ...
                              <input type="username" name="semester"  id="name" placeholder="semester" />
                           </div>
                           <div class="username">&nbsp;&nbsp;&nbsp; dept_id:-	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                           <select name="dropdown" id="dropdown">
			
                    <%List<Semester> list = AdminDao.getAllSemester(); %>
         <%for(Semester u1:list){ %>
           <option value="<%=u1.getDept_id() %>"><%=u1.getDept_id() %></option>
         ...
         <%} %>
                        ...
                        <br>
                        <a>
                           <input type="submit" name="action" class="sign-btn" value="Add semester">
                           <div class="link">
  ...
  <%for(Semester u1:list1){ %>
    <tr>
    	<td><%=u1.getId() %></td>
    	<td><%=u1.getSemester() %></td>
    	
    	<td>
    		<form action="AdminController" method="post">
    			<input type="hidden" name="id" value="<%=u1.getId()%>">
    			<input type="hidden" name="action" value="semester_edit">
    	...
    	<td>
    		<form action="AdminController" method="post">
    			<input type="hidden" name="id" value="<%=u1.getId()%>">
    			<input type="hidden" name="action" value="semester_delete">
