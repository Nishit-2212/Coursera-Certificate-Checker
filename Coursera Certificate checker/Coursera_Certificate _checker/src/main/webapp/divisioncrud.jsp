...
<html lang="en">
   ...
   <body>
      ...
      <div class="wrapper">
                     ...
                     <div class="form-wrapper">
                        ...
                        <div class="input-text">
                           <div class="username">
                              ...
                              <input type="username" name="division"  id="name" placeholder="division" />
                           </div>
                           <div class="username">&nbsp;&nbsp;&nbsp; sem_id:-	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                           <select name="dropdown" id="dropdown">
			
                    <%List<Semester> list = AdminDao.getAllSemesters(); %>
         ...
         <%} %>
                        ...
                        <br>
                        <a>
                           <input type="submit" name="action" class="sign-btn" value="Add division">
                           <div class="link">
  ...
  <tbody>
  <%List<Division> list1 = AdminDao.getAllDivision(); %>
  <%for(Division u1:list1){ %>
    <tr>
    	<td><%=u1.getId() %></td>
    	...
    	<td>
    		<form action="AdminController" method="post">
    			...
    			<input type="hidden" name="action" value="division_edit">
