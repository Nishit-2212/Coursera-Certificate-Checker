<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@page import="model.Studentcomplete"%>
...
<html lang="en">
   ...
   <body>
      ...
      <div class="wrapper">
               ...
               <div class="box" id="myDiv">
                   <form action="AdminController" method="post">
                     <div class="form-wrapper">
                        <div class="circle">
                           <img src="img/coursera-logo.png" alt="cat">
                        </div>
                        <div class="heading">Coursera Completed data</div>
                        <div class="input-text">
                           <div class="username">&nbsp;&nbsp;&nbsp; dept_name:-	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <select name="dropdown" id="dropdown" onchange="fetchdata()">
			
                    <%List<Department> list = AdminDao.getAllDepartment(); %>
         <%for(Department u1:list){ %>
           <option value="<%=u1.getId() %>"><%=u1.getDepartment() %></option>
         ...
         <%} %>
                           ...
                           <div class="username">&nbsp;&nbsp;&nbsp; sem_name:-	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                           <select name="dropdown1" id="dropdown1">
			
                    <%List<Semester> list1 = AdminDao.getAllSemesters(); %>
         <%for(Semester u1:list1){ %>
           <option value="<%=u1.getId() %>"><%=u1.getSemester() %></option>
         ...
         <%} %>
                           ...
                           <div class="username">
                              ...
                              <input type="username" name="division"  id="name" placeholder="division name" />
                           </div>
                        </div>
                        <br>
                        <a>
                           <input type="submit" name="action" class="sign-btn" value="See Students">
                           <div class="link">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Student Enrollment no.</th>
      <th scope="col">Course Name</th>
      <th scope="col">Semester Name</th>
      <th scope="col">certificate_path</th>
  ...
  <tbody>
  <%List<Studentcomplete> list3 = AdminDao.getAllCompleteddata(); %>
  <%for(Studentcomplete u1:list3){ 
  
  		  Student s = AdminDao.getStudentById(u1.getStu_id()); 
  		  Course c = AdminDao.getCourseById(u1.getCo_id());  
  		  Semester d = AdminDao.getSemesterById(s.getSem_id());%>
    <tr>
    	
    	<td><%= s.getEnrollment_no() %></td>
    	<td><%= c.getCourse() %></td>
    	<td><%= (d != null) ? d.getSemester() : "Semester Not Available" %></td>
    	<td><%=u1.getCertificate_path() %></td>
        <td><%=u1.getSubmit_date() %></td>
    	
    	
    	<td>
    		<form action="AdminController" method="post">
    			<input type="hidden" name="id" value="<%=u1.getId()%>">
    			<input type="hidden" name="action" value="completed_delete">
