...
<html lang="en">
  ...
  <%Course d =(Course)request.getAttribute("course"); %>
   <script>
                     ...
                     <div class="form-wrapper">
                        ...
                        <div class="input-text">
                           <div class="username">
                              ...
                              <input type="text" name="course"  id="name"  value="<%= d.getCourse() %>" />
                           </div>
                        ...
                        <br>
                        <a>
                           <input type="submit" name="action" class="sign-btn" value="Update Course">
                           <div class="link">
