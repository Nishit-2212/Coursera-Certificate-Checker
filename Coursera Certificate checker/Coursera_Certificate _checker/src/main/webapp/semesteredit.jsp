...
<html lang="en">
   ...
   <body>
  <%Semester d =(Semester)request.getAttribute("semester"); %>
      <div class="wrapper">
         <div class="section">
            <div class="container">
               <div class="box" id="myDiv">
                  <form action="AdminController" method="post">
                     <div class="form-wrapper">
                        ...
                        <div class="heading">Edit Semester</div>
                        <div class="input-text">
                           <div class="username">
                              ...
                              <input type="text" name="semester"  id="name"  value="<%= d.getSemester() %>" />
                           </div>
                        ...
                        <br>
                        <a>
                           <input type="submit" name="action" class="sign-btn" value="Update Semester">
                           <div class="link">
