...
<html lang="en">
  ...
  <%Faculty d =(Faculty)request.getAttribute("faculty"); %>
               ...
               <div class="box" id="myDiv">
                  <form action="AdminController" method="post">
                     <div class="form-wrapper">
                        ...
                        <div class="heading">Edit Faculty</div>
                        <div class="input-text">
					       ...
					       <div class="username">
                              ...
                              <input type="text" name="email"  id="name"  value="<%= d.getEmail() %>" />
                           </div>
                           <div class="username">
                              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="18" fill="currentColor" class="bi bi-person-plus-fill" viewBox="0 0 16 16">
                                 <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                              ...
                              <input type="text" name="password"  id="name"  value="<%= d.getPassword() %>" />
                           </div>
                        ...
                        <br>
                        <a>
                           <input type="submit" name="action" class="sign-btn" value="Update Faculty">
                           <div class="link">
