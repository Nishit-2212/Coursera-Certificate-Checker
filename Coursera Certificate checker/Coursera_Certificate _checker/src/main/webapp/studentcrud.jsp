...
<html lang="en">
   ...
   <body>
               ...
               <div class="box" id="myDiv">
                  <form action="ExcelController" method="post" enctype="multipart/form-data">
                     <div class="form-wrapper">
                        ...
                        <div class="heading">Student Add</div>
     ...
     <input type="file" name="file" accept=".xls,.xlsx">
                        ...
                        <br>
                        <a>
                           <input type="submit" name="action" class="sign-btn" value="Add Student">
                  ...
                  <form action="AdminController" method="post">
                     <div class="form-wrapper">
                        ...
                        <div class="heading">Student view</div>
                        <br>
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
         ...
         <%} %>
                    ...
                    <%List<Semester> list2 = AdminDao.getAllSemesters(); %>
         <%for(Semester u1:list2){ %>
           <option value="<%=u1.getSemester() %>"><%=u1.getSemester() %></option>
         ...
         <%} %>
                        ...
                        <div class="input-text">
                           <div class="username">
                              ...
                              <input type="username" name="division"  id="name" placeholder="division_name" />
                           </div>
                        ...
                        <br>
                        <a>
                           <input type="submit" name="action" class="sign-btn" value="See Student">
                           <div class="link">
