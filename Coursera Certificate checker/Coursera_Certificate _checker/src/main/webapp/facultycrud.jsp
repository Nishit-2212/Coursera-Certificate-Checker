...
<html lang="en">
                     ...
                     <div class="form-wrapper">
                        ...
                        <div class="input-text">
                           <div class="username">
                              ...
                              <input type="username" name="name"  id="name" placeholder="Faculty Name" />
                           </div>
                           <div class="username">
                              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="18" fill="currentColor" class="bi bi-person-plus-fill" viewBox="0 0 16 16">
                                 <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                              ...
                              <input type="username" name="email"  id="name" placeholder="Email" />
                           </div>
                           <div class="username">
                              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="18" fill="currentColor" class="bi bi-person-plus-fill" viewBox="0 0 16 16">
                                 <path d="M1 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/>
                              ...
                              <input type="username" name="password"  id="name" placeholder="Password" />
                           </div>
                          
                        </div>
                        <br>
                        <a>
                           <input type="submit" name="action" class="sign-btn" value="Add faculty">
                           <div class="link">
  ...
  <tbody>
  <%List<Faculty> list1 = AdminDao.getAllFaculty(); %>
  <%for(Faculty u1:list1){ %>
    <tr>
    	<td><%=u1.getId() %></td>
    	<td><%=u1.getName() %></td>
    	<td><%=u1.getEmail() %></td>
    	<td>
    		<form action="AdminController" method="post">
    			...
    			<input type="hidden" name="action" value="faculty_edit">
    	...
    	<td>
    		<form action="AdminController" method="post">
    			<input type="hidden" name="id" value="<%=u1.getId()%>">
    			<input type="hidden" name="action" value="faculty_delete">
