               ...
               <div class="box" id="myDiv">
                  <form action="AdminController" method="post">
                     <div class="form-wrapper">
                        ...
                        <div class="heading">Edit Department</div>
                        <div class="input-text">
                           <div class="username">
                              ...
                              <input type="text" name="department"  id="name"  value="<%= d.getDepartment() %>" />
                           </div>
                        ...
                        <br>
                        <a>
                           <input type="submit" name="action" class="sign-btn" value="Update Department">
                           <div class="link">
