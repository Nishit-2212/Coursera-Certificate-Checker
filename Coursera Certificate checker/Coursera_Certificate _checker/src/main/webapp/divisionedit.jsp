...
<html lang="en">
  ...
  <%Division d =(Division)request.getAttribute("division"); %>
   <script>
    document.getElementById("dropdown").value = "<%= d.getSem_id() %>"; 
</script>
      <div class="wrapper">
         <div class="section">
            <div class="container">
                     ...
                     <div class="form-wrapper">
                        ...
                        <div class="input-text">
                           <div class="username">
                              ...
                              <input type="text" name="division"  id="name"  value="<%= d.getDivision() %>" />
                           </div>
                        ...
                        <br>
                        <a>
                           <input type="submit" name="action" class="sign-btn" value="Update Division">
                           <div class="link">
